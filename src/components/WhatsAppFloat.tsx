...
export function WhatsAppFloat({ href = WA_LINK }: { href?: string }) {
  return (
    <a
      href={href}
      target="_blank"
      ...
      className="fixed bottom-5 right-5 z-50 flex h-12 w-12 items-center justify-center rounded-full text-white transition-transform hover:scale-110 active:scale-95 sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
      style={{
